...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-06-2023 a las 22:28:16
...
(4, 'Baja en carbohidratos', '[\"Omelet con queso, espinaca y tocino\",\"Ensalada de atun con lechuga\",\"Sandwich ave palta\"]'),
...
(7, 'Paleo', '[\"Ensalada de pollo a la parrilla con aguacate, tomate y lechuga\",\"Tortilla de huevo con espinacas y champiñones\",\"Sardinas enlatadas\"]'),
...
INSERT INTO `rutina` (`ID_Rutina`, `Nombre`, `Ejercicio`) VALUES
...
--
ALTER TABLE `dieta`
  MODIFY `ID_Dieta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
